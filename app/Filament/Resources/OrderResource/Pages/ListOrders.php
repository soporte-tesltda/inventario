...
class ListOrders extends ListRecords
{
    ...
    protected ?string $subheading = 'Gestiona las órdenes de venta';
    ...
    public function getTabs(): array
    {
        ...
        $tabs['last_month'] = Tab::make('Mes Pasado')
